...
data = np.genfromtxt('/home/pratima/Biased-PeriodicLigand/dump_files/lig.' + args.bias + '.new', delimiter=' ')
...
hist_data = np.genfromtxt('/home/pratima/Biased-PeriodicLigand/dump_files/theta' + args.bias + '.txt', delimiter=' ')
